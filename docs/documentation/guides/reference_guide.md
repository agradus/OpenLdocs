...
| **format**(pattern, parameter(s))                                                                                                                                                                            | Returns the values according to the specified pattern. <br/>**Example:** format("The user {1} has policy number {0}","P2289818293","Alex") <br/>returns <br/>The user Alex has policy number P2289818293                                                                                                                                                                                                                                                                                                                                                 |         	
