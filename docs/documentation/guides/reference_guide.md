...
| **error**(String code, String message)                                                                                                                                                                          | Returns a custom error with custom error code, both defined as arguments, in the HTTP response, OpenL Tablets WebStudio UI, and in the logs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |         
