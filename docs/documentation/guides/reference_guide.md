...
| **format**(pattern, parameter(s))                                                                                                                                                                          | Returns the values according to the specified pattern. **Example:** format("The user {1} has policy number {0}","P2289818293","Alex") returns "The user Alex has policy number P2289818293".                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |   	
