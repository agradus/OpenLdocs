...
| Function                                                         | Description                                                                                                                          |
|------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|
| **add**(array,element)                                           | Creates a copy of the given array and adds one or more specified elements or an array of elements at the end of the new array.<br/><br/> Parameters:array: The array to be copied. <br/><br/> elements: One or more elements to be added, or an array of elements. This is a varargs parameter, allowing for multiple elements to be specified. <br/><br/> Examples:add(states, "Texas") - Creates a new array with all elements of states plus "Texas" at the end. <br/><br/> add(states, "California", "Nevada", "Oregon") - Creates a new array with all elements of states plus "California", "Nevada", and "Oregon" added at the end.<br/><br/> add(states, newStates) - Creates a new array with all elements of states plus all elements of newStates added at the end.                                                     |
...
| **addElement**(array, index, element)                            | Creates a copy of the given array and inserts one or more specified elements of states or an array of elements at the specified position in the array.<br/><br/> Parameters:<br/><br/>array: The array into which the elements are to be inserted.<br/><br/>index: The position in the array where the new elements should be inserted. This is a zero-based index.<br/><br/>elements: One or more elements to be inserted, or an array of elements. This is a varargs parameter, allowing for multiple elements to be specified.<br/><br/> Examples:<br/><br/>addElement(states, 3, "Texas") - Creates a new array with all elements of states plus "Texas" at the 4th position in the states array.<br/><br/> addElement(states, 2, "California", "Nevada", "Oregon") - Creates a new array with all elements of states plus  "California", "Nevada", and "Oregon" starting at the 3rd position in the states array.<br/><br/>addElement(states, 1, newStates) - Creates a new array with all elements of states plus  all elements of newStates array starting at the 2nd position in the states array.                                                              |
